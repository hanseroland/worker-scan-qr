...
export const config: Config = {
    app: {
        ...
        corsOriginLocal: process.env.CORS_ORIGIN_LOCAL || "http://localhost:3000,http://localhost:5000",
        corsOriginProd: process.env.CORS_ORIGIN_PROD || "https://your-production-domain.com",
    },
    db: {
