...
export class EmailService implements IEmailService {
    ...
    async sendEmail(to:string, subject:string, htmlContent:string): Promise<void> {
     ...
     async sendWelcomeEmail(to: string, activationToken: string): Promise<void> {
        ...
        const activationUrl = config.app.env === 'production'
    ...
    async sendResetPasswordEmail(to:string, token:string): Promise<void> {
        ...
        const resetUrl = config.app.env === 'production'
    ...
    async sendEmployeeCode(to: string, employeeCode: string, companyName: string): Promise<void> {
